...
import type { AttachmentKind } from "@/app/generated/prisma/client";
import { getApiErrorMessage, parseApiEnvelope } from "@/lib/api/client";
import type { EditableCase } from "@/app/cases/case.shared";
...
export async function uploadCaseAttachmentApi(caseId: string, kind: AttachmentKind, file: File) {
