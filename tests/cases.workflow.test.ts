  ...
  assert.deepEqual(stub.createdCaseServices, [
    {
      ...
      service_base_price_snapshot: "100.00",
      delivery_buffer_days_snapshot: 0,
      unit_price: "100.00",
  ...
  assert.deepEqual(stub.caseProcessRows, [
    {
      ...
      snapshot_fixed_minutes: 1,
      snapshot_minutes_per_unit: 0,
      snapshot_expected_duration_days: 1,
      snapshot_dependency_lag_days: 0,
      snapshot_requires_milling_machine: false,
